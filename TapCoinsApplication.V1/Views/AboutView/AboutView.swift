...
struct AboutView: View {
    ...
    let tapCoinsStringVar = Text("TapCoins").font(.system(size: UIScreen.main.bounds.width * 0.055))
        .foregroundColor(CustomColorsModel().colorSchemeOne)
    let freePlayStringVar = Text("Free Play").font(.system(size: UIScreen.main.bounds.width * 0.055))
        .foregroundColor(CustomColorsModel().colorSchemeEight)
                    ...
                    ScrollView{
                        VStack{
                            VStack(alignment: .leading, spacing: UIScreen.main.bounds.width * 0.14){
                                ...
                                Text("\(tapCoinsStringVar) is a high-speed one vs one game where you have 15 seconds to tap as many coins as you can before your oppenent! Compete against friends in \(customGameStringVar) to see whos better or rank up by beating players in your rank in \(freePlayStringVar).")
...
//                        sign up with phone or email to enter \(tapDashStringVar) mode and play to win \(tapCoinsStringVar) and earn real money! For more information on \(tapDashStringVar) scroll below.
//                        VStack{
